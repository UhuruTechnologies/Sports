...
// Add missing imports
function Info(props: { children: React.ReactNode }) {
  return <div className="text-slate-400 text-sm">{props.children}</div>
}

function Check(props: { children: React.ReactNode }) {
  return <div className="text-green-500 text-sm">{props.children}</div>
}
